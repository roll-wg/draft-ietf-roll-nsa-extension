...
DRAFT:=draft-ietf-roll-nsa-extension
VERSION:=$(sh ./getver ${DRAFT}.mkd )
...
submit: ${DRAFT}.xml
	curl -s -F "user=aris@ariskou.com" ${REPLACES} -F "xml=@${DRAFT}.xml" https://datatracker.ietf.org/api/submission | jq
